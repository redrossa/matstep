...
class EqualizerMapper(pymbolic.mapper.Mapper):
    ...
    Use this mapper in order to avoid `TypeError` being raised since `pymbolic
    .Expression.__eq__` method will fail if a foreign object in the pymbolic
    expression tree is unhashable.
    """
